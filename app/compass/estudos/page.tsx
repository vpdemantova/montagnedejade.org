    ...
    <div className="min-h-screen">
      <header className="ph">
        <div className="page-standard flex items-end justify-between gap-6">
          <div>
            <p className="page-label mb-3">Compass · Estudos</p>
      ...
      <main className="page-standard py-6 space-y-4">
        ...
        {showForm && (
          <div className="border border-solar-border/30 bg-solar-deep/30 p-5 space-y-3">
            ...
            <div className="flex gap-2">
              <button onClick={addDiscipline} className="btn btn-primary btn-md">Adicionar</button>
              <button onClick={() => setShowForm(false)} className="btn btn-ghost btn-md">
                Cancelar
              </button>
            </div>
          </div>
